...
2. **Topic 폴더 생성**
   - Bash tool을 사용하여 폴더 생성:
     ```bash
     mkdir -p "c:\AI_study\2026\CatchUpAI_VL\Topics\{TopicName}"
     mkdir -p "c:\AI_study\2026\CatchUpAI_VL\Topics\{TopicName}\vl_prompts"
     mkdir -p "c:\AI_study\2026\CatchUpAI_VL\Topics\{TopicName}\vl_roadmap"
     mkdir -p "c:\AI_study\2026\CatchUpAI_VL\Topics\{TopicName}\vl_worklog"
     mkdir -p "c:\AI_study\2026\CatchUpAI_VL\Topics\{TopicName}\vl_materials"
     ```
   - 성공 메시지 출력:
     ```
...
3. **topic_starter.md 템플릿 제공**
   - Read tool로 템플릿 읽기:
     ```
     파일: c:\AI_study\2026\CatchUpAI_VL\templates\topic_starter.md
     ```
   - 전체 내용을 사용자에게 보여주기
   - 안내 메시지:
     ```
...
3. **roadmap_prompt_template.md 제공**
   - Read tool로 템플릿 읽기:
     ```
     파일: c:\AI_study\2026\CatchUpAI_VL\templates\roadmap_prompt_template.md
     ```
   - Topic 이름으로 변수 치환
   - 완성된 프롬프트를 사용자에게 제공
...
5. **daily_learning_prompt.md 제공**
   - Read tool로 읽기:
     ```
     파일: c:\AI_study\2026\CatchUpAI_VL\Topics\Claude-Skills\vl_prompts\daily_learning_prompt.md
     ```
   - 전체 내용 제공
...
### Read Tool
- 템플릿 파일 읽기: `c:\AI_study\2026\CatchUpAI_VL\templates\{파일명}`
